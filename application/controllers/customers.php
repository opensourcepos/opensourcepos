...
class Customers extends Person_controller {
	...
	function index() {
		...
		$data['selected_module'] = 'customers';
	...
	function basic_info() {
 		$this->smartyci->display( 'people/form_basic_info.php.tpl' );
	}
	...
	*/
	function view($customer_id=-1) {
		...
		$this->smartyci->assign($data);
 		$this->smartyci->display( 'customers/form.php.tpl' );
	}
	...
	*/
	...
	function excel() {
		...
		$query = $this->Customer->get_all_export();
	...
	function excel_import() {
		$data["modal_id"]='#'.$this->input->get('modal_id', true);
		$this->smartyci->assign($data);
 		$this->smartyci->display( 'customers/excel_import.php.tpl' );
	}
