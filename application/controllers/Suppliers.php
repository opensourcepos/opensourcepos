	...
	*/
	public function save($supplier_id = -1)
	{
		...
		if($this->Supplier->save_supplier($person_data, $supplier_data, $supplier_id))
		{
			...
			// Save person_attributes for new supplier
				/*
				change default new supplier creation ID to the ID in the supplier data to be sent to database 
				*/
			...
			else //Existing supplier
			{
				...
				// Update Person_attributes for existing supplier
