...
class Sales extends Secure_Controller
{
	...
	public function complete()
	{
		...
		{
			// generate final invoice number		// TODO This is a complete list of all of the supported tokens.
			...
			$supported_tokens = array($token_invoice_sequence, $token_customer,
				$token_invoice_count, $token_quote_sequence, $token_suspended_invoice_count,
				$token_year_invoice_count);

			$this->token_lib->register($supported_tokens);
...
//		$data['invoice_number'] = 'XXXXXXXXXX';
