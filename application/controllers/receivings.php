...
class Receivings extends Secure_area
{
	...
	function edit($receiving_id) {
		...
		$this->smartyci->assign($data);
 		$this->smartyci->display( 'receivings/form.php.tpl' );
	}
    ...
    $data['stock_location']=$this->receiving_lib->get_stock_source();
		...
		if ($this->receiving_lib->is_invoice_number_enabled() && $this->Receiving->invoice_number_exists($invoice_number)) {
			...
			$this->smartyci->assign($data);
			$this->smartyci->display("receivings/receipt.php.tpl");
    ...
    $this->smartyci->assign($data);
		//$this->smartyci->useCached( 'receivings/receiving.php.tpl' );
    $this->smartyci->display( 'receivings/receiving.php.tpl' );
	...
	function save($receiving_id) {
		...
		if ($this->input->post('invoice_number') != '') {
			$receiving_data['invoice_number'] = $this->input->post('invoice_number');
		}
