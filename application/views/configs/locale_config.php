...
$this->load->view('configs/config_header', $title_locale);
?>
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-2'>
				<?php echo form_dropdown(
					...
					$this->config->item('currency_decimals'),
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-2'>
				<?php echo form_dropdown(
					...
					$this->config->item('quantity_decimals'),
					array('class' => 'form-control input-sm')
				);
				?>
			</div>
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-2'>
				<?php echo form_dropdown(
					...
					$this->config->item('cash_decimals'),
					array('class' => 'form-control input-sm')
				);
				?>
			</div>
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-4'>
				<?php echo form_dropdown(
					...
					$this->config->item('payment_options_order'),
					array('class' => 'form-control input-sm')
				);
				?>
			</div>
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-2'>
				<?php echo form_dropdown(
					...
					$this->config->item('financial_year'),
					array('class' => 'form-control input-sm')
				);
				?>
			</div>
