<?= form_open('config/save_tax/', array('id' => 'tax_config_form', 'class' => 'form-horizontal')); ?>

<?php
$title_tax['config_title'] = $this->lang->line('config_tax_configuration');
$this->load->view('configs/config_header', $title_tax);
?>
...
<div id="config_wrapper">
	<fieldset id="config_info">
		...
		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_tax_id'), 'tax_id', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_input(array(
					'name' => 'tax_id',
					'id' => 'tax_id',
		...
		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_tax_included'), 'tax_included', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_checkbox(array(
					'name' => 'tax_included',
					'id' => 'tax_included',
		...
		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_default_tax_rate_1'), 'default_tax_1_rate', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_input(array(
		...
		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_default_tax_rate_2'), 'default_tax_2_rate', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_input(array(
		...
		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_use_destination_based_tax'), 'use_destination_based_tax', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_checkbox(array(
		...
		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_default_tax_code'), 'default_tax_code', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_dropdown('default_tax_code', $tax_code_options, $this->config->item('default_tax_code'), array('class' => 'form-control input-sm')); ?>
			</div>
		</div>

		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_default_tax_category'), 'default_tax_category', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_dropdown('default_tax_category', $tax_category_options, $this->config->item('default_tax_category'), array('class' => 'form-control input-sm')); ?>
			</div>
		</div>

		<div class="form-group form-group-sm">
			<?= form_label($this->lang->line('config_default_tax_jurisdiction'), 'default_tax_jurisdiction', array('class' => 'control-label col-xs-2')); ?>
			<div class='col-xs-2'>
				<?= form_dropdown('default_tax_jurisdiction', $tax_jurisdiction_options, $this->config->item('default_tax_jurisdiction'), array('class' => 'form-control input-sm')); ?>
			</div>
		</div>
