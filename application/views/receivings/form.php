	...
	<fieldset id='receiving_basic_info'>
		...
		<div class='form-group form-group-sm'>
			...
			<div class='col-xs-8'>
				<?php echo form_input(array(
						'name'	=> 'date',
						'value'	=> date($this->config->item('dateformat') . ' ' . $this->config->item('timeformat'), strtotime($receiving_info['receiving_time'])),
						'id'	=> 'datetime',
		...
		<div class='form-group form-group-sm'>
			...
			<div class='col-xs-8'>
				<?php echo form_input(array(
						'name'	=> 'reference',
						'value'	=> $receiving_info['reference'],
						'id'	=> 'reference',
						'class'	=> 'form-control input-sm'));
				?>
			</div>
