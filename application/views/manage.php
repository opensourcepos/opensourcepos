...
$(document).ready(function()
{
	...
	table_support.init({
		resource: '<?php echo site_url($controller_name.'s');?>',
...
<div id="title_bar" class="print_hide btn-toolbar">
	...
	<button class='btn btn-info btn-sm pull-right modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-href='<?php echo site_url($controller_name."s/view"); ?>'
