...
?>
	<div class="form-group form-group-sm" style="<?= $reward_category['deleted'] ? 'display:none;' : 'display:block;' ?>">
		<?= form_label($this->lang->line('config_customer_reward') . ' ' . $i, 'customer_reward_' . $i, array('class' => 'required control-label col-xs-2')); ?>
		<div class='col-xs-2'>
			<?php $form_data = array(
		...
		<i class="add_customer_reward bi bi-plus pt-2"></i>
		<span>&nbsp;&nbsp;</span>
		<i class="remove_customer_reward bi bi-dash pt-2"></i>
	</div>
<?php
}
?>