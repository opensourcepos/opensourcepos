...
?>
	<div class="form-group form-group-sm" style="display:block;">
		<?= form_label($this->lang->line('taxes_tax_jurisdiction') . ' ' . $i, 'jurisdiction_name_' . $i, array('class' => 'control-label col-xs-2')); ?>
		<div class='col-xs-2'>
			<?php $form_data = array(
		...
		<div class='col-xs-2'>
			<?= form_dropdown('tax_type[]' . $i, $tax_types, $tax_type, array('class' => 'form-control'));	?>
		</div>
		...
		<i class="add_tax_jurisdiction bi bi-plus pt-2"></i>
		<span>&nbsp;&nbsp;</span>
		<i class="remove_tax_jurisdiction bi bi-dash pt-2"></i>
