...
if (!file_exists(APPPATH."libraries/barcodegen/html/config/" . $code . '.php')) {
    showError();
}

include_once(APPPATH."libraries/barcodegen/html/config/" . $code . '.php');

$class_dir = APPPATH."libraries/barcodegen/" . 'class';
...
include_once(APPPATH."libraries/barcodegen/html/config/". $baseClassFile);
