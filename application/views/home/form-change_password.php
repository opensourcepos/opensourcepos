			...
			<div class="modal-header">
				<ul class="nav nav-pills nav-justified w-100">
					...
					<li class="nav-item" title="<?php echo $this->lang->line('employees_change_password'); ?>">
						<button type="button" class="nav-link active" aria-current="page"><?php echo $this->lang->line('employees_change_password'); ?></button>
					</li>
				</ul>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body text-start">
				<h6><span class="badge bg-danger"><?php echo $this->lang->line('common_fields_required_message'); ?></span></h6>
