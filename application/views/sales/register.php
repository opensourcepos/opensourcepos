		...
		?>
			...
			<?php echo form_open("sales/cancel", array('id'=>'buttons_form', 'class'=>'form-horizontal')); ?>
				<div class="form-group" id="buttons_sale">
					<div class='btn btn-sm btn-default pull-left btn-block' id='suspend_sale_button'><?php echo $this->lang->line('sales_suspend_sale'); ?></div>
					<!-- Boton para imprimir formulario de ventas -->
					<div class='btn btn-sm btn-primary pull-left btn-block' id='print_button'>Imprimir Proforma</div>
					<!-- Boton para imprimir formulario de ventas -->
					<div class='btn btn-sm btn-danger pull-right btn-block' id='cancel_sale_button'><?php echo $this->lang->line('sales_cancel_sale'); ?></div>
				</div>
...
$(document).ready(function()
{
    ...
    //accion para imprimir el formulario de la proforma
    $("#print_button").click(function()
    {
    	if (confirm('Desea imprimir la proforma'))
    	{
    		$('#buttons_form').attr('action', '<?php echo site_url("sales/complete_proforma"); ?>');
    		$('#buttons_form').submit();
    	}
    });
