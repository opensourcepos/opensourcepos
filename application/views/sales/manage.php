...
<div id="title_bar" class="print_hide btn-toolbar">
	<button onclick="javascript:printdoc()" class='btn btn-primary pull-right'>
		<i class="bi bi-printer pe-1"></i><?= $this->lang->line('common_print'); ?>
	</button>
	<?= anchor("sales", '<i class="bi bi-cart2 pe-1"></i>' . $this->lang->line('sales_register'), array('class' => 'btn btn-primary pull-right', 'id' => 'show_sales_button')); ?>
</div>

<div id="toolbar">
	<div class="pull-left form-inline" role="toolbar">
		<button id="delete" class="btn btn-outline-secondary print_hide">
