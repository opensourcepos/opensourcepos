<div id="receipt_wrapper" style="font-size:<?= $this->config->item('receipt_font_size'); ?>px">
	...
	<table id="receipt_items">
		<tr>
			...
			<th style="width:20%;" class="total-value"><?= $this->lang->line('sales_total'); ?></th>
		...
		?>
				...
				<tr>
					...
					<?php if ($this->config->item('receipt_show_serialnumber')) { ?>
		...
		<?php if ($this->config->item('receipt_show_total_discount') && $discount > 0) { ?>
			...
			<tr>
				<td colspan="3" class="total-value"><?= $this->lang->line('sales_customer_discount'); ?>:</td>
		...
		<tr>
			<td colspan="3" style="text-align:right;<?= $border ? 'border-top: 2px solid black;' : ''; ?>"><?= $this->lang->line('sales_total'); ?></td>
