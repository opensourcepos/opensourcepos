	...
	<table id="receipt_items">
		...
		foreach($cart as $line=>$item)
		{
			...
			?>
				<tr>
					...
					<td class="total-value"><?php echo to_currency($item[($this->config->item('receipt_show_total_discount') ? 'total' : 'discounted_total')], $exchange_rate_set); ?></td>
				</tr>
				<tr>
					<?php
		...
		?>
			<tr>
				...
				<td style='text-align:right;border-top:2px solid #000000;'><?php echo to_currency($prediscount_subtotal, $exchange_rate_set); ?></td>
			</tr>
			<tr>
				<td colspan="3" class="total-value"><?php echo $this->lang->line('sales_customer_discount'); ?>:</td>
				<td class="total-value"><?php echo to_currency($discount * -1, $exchange_rate_set); ?></td>
			</tr>
		<?php
		}
		?>
		...
		?>
			...
			?>
				<tr>
					...
					<td class="total-value"><?php echo to_currency_tax($tax['sale_tax_amount'], $exchange_rate_set); ?></td>
				</tr>
			<?php
			}
			?>
		...
		<tr>
			...
			<td style="text-align:right;<?php echo $border? 'border-top: 2px solid black;' :''; ?>"><?php echo to_currency($total, $exchange_rate_set); ?></td>
		</tr>
		...
		?>
			<tr>
				...
				<td class="total-value"><?php echo to_currency( $payment['payment_amount'] * -1, $exchange_rate_set ); ?></td>
			</tr>
		<?php
		}
		?>
		...
		?>
			<tr>
				...
				<td class="total-value"><?php echo to_currency($cur_giftcard_value, $exchange_rate_set); ?></td>
			</tr>
		<?php
		}
		?>
		<tr>
			...
			<td class="total-value"><?php echo to_currency($amount_change, $exchange_rate_set); ?></td>
		</tr>
	</table>
