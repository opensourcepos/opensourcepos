<?= form_open('items', array('id' => 'item_form', 'class' => 'form-horizontal')); ?>
<fieldset id="count_item_basic_info">
	<div class="form-group form-group-sm">
		<?= form_label($this->lang->line('items_item_number'), 'name', array('class' => 'control-label col-xs-3')); ?>
		<div class="col-xs-8">
	...
	<div class="form-group form-group-sm">
		<?= form_label($this->lang->line('items_stock_location'), 'stock_location', array('class' => 'control-label col-xs-3')); ?>
		<div class='col-xs-8'>
			<?= form_dropdown('stock_location', $stock_locations, current($stock_locations), array('onchange' => 'display_stock(this.value);', 'class' => 'form-control'));	?>
		</div>
	</div>

	<div class="form-group form-group-sm">
		<?= form_label($this->lang->line('items_current_quantity'), 'quantity', array('class' => 'control-label col-xs-3')); ?>
		<div class='col-xs-4'>
			<?= form_input(
				array(
					'name' => 'quantity',
...
<table id="items_count_details" class="table table-striped table-hover">
	<thead>
		<tr style="background-color: #999 !important;">
			<th colspan="4"><?= $this->lang->line('items_inventory_data_tracking'); ?></th>
		</tr>
		<tr>
			<th width="30%"><?= $this->lang->line('items_inventory_date'); ?></th>
			<th width="20%"><?= $this->lang->line('items_inventory_employee'); ?></th>
			<th width="20%"><?= $this->lang->line('items_inventory_in_out_quantity'); ?></th>
			<th width="30%"><?= $this->lang->line('items_inventory_remarks'); ?></th>
		</tr>
	</thead>
