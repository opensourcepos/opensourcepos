...
<?= form_open($controller_name . '/save/' . $person_info->person_id, array('id' => 'employee_form', 'class' => 'form-horizontal')); ?>
<ul class="nav nav-tabs nav-justified" data-tabs="tabs">
	<li class="active" role="presentation">
		<a data-bs-toggle="tab" href="#employee_basic_info"><?= $this->lang->line("employees_basic_information"); ?></a>
	</li>
	<li role="presentation">
		<a data-bs-toggle="tab" href="#employee_login_info"><?= $this->lang->line("employees_login_info"); ?></a>
	</li>
	<li role="presentation">
		<a data-bs-toggle="tab" href="#employee_permission_info"><?= $this->lang->line("employees_permission_info"); ?></a>
	</li>
</ul>
...
<div class="tab-content">
	...
	<div class="tab-pane" id="employee_login_info">
		<fieldset>
			...
			<div class="form-group form-group-sm">
				<?= form_label($this->lang->line('employees_language'), 'language', array('class' => 'control-label col-xs-3')); ?>
				<div class='col-xs-8'>
					<div class="input-group">
						<?php
	...
	<div class="tab-pane" id="employee_permission_info">
		<fieldset>
			...
			<ul id="permission_list">
				...
				?>
					<li>
						<?= form_checkbox("grant_" . $module->module_id, $module->module_id, $module->grant, "class='module'"); ?>
						<?= form_dropdown("menu_group_" . $module->module_id, array(
						...
						<span class="medium"><?= $this->lang->line('module_' . $module->module_id); ?>:</span>
						<span class="small"><?= $this->lang->line('module_' . $module->module_id . '_desc'); ?></span>
						<?php
						...
						?>
									<ul>
										<li>
											<?= form_checkbox("grant_" . $permission->permission_id, $permission->permission_id, $permission->grant); ?>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$.validator.addMethod('module', function(value, element) {
			...
			return result;
		}, "<?= $this->lang->line('employees_subpermission_required'); ?>");
		...
		$('#employee_form').validate($.extend({
			...
			rules: {
				...
				username: {
					...
					required: true,
					minlength: 5,
					remote: '<?= site_url("$controller_name/check_username/$employee_id") ?>'
				},
				password: {
					<?php
			...
			messages: {
				...
				username: {
					...
					remote: "<?= $this->lang->line('employees_username_duplicate'); ?>"
				},
				password: {
					<?php
					if ($person_info->person_id == "") {
