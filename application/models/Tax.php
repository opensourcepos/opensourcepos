...
class Tax extends CI_Model
{
	 ...
	 public function get_taxes($tax_code_id, $tax_category_id)
	{
		$query = $this->db->query('select tax_rate_id, rate_tax_code_id, tax_code, tax_code_name, tax_type, cascade_sequence, rate_tax_category_id, tax_category, 
			rate_jurisdiction_id, jurisdiction_name, tax_rate, tax_rounding_code,tax_categories.tax_group_sequence + tax_jurisdictions.tax_group_sequence as tax_group_sequence 
			...
			where rate_tax_code_id = \'' . $tax_code_id . '\' and rate_tax_category_id = ' . $tax_category_id . '
			order by cascade_sequence, jurisdiction_name, tax_jurisdictions.tax_group_sequence + tax_categories.tax_group_sequence');
