		...
		$this->db->query('CREATE TEMPORARY TABLE IF NOT EXISTS ' . $this->db->dbprefix('receivings_items_temp') .
			...
			(
				SELECT 
					...
					MAX(item_unit_price * receivings_items.receiving_quantity * quantity_purchased - item_unit_price * quantity_purchased * discount_percent / 100) AS subtotal,
					MAX(item_unit_price * receivings_items.receiving_quantity * quantity_purchased - item_unit_price * quantity_purchased * discount_percent / 100) AS total,
					MAX((item_unit_price * receivings_items.receiving_quantity * quantity_purchased - item_unit_price * quantity_purchased * discount_percent / 100) - (item_cost_price * quantity_purchased)) AS profit,
