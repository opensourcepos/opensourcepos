...
- Never reference security advisory IDs (CVE, GHSA, etc.) in code, comments, commit messages, or docblocks — treat them the same as secrets. They act as a roadmap for attackers researching the exact exploit a fix addresses.
