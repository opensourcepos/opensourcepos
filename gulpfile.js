...
// Copy AdminLTE 4 assets
gulp.task('copy-adminlte', function () {
    // AdminLTE CSS
    pipeline(gulp.src('./node_modules/admin-lte/dist/css/adminlte.min.css*'), gulp.dest('public/resources/adminlte/css'));
    // AdminLTE JS
    pipeline(gulp.src('./node_modules/admin-lte/dist/js/adminlte.min.js*'), gulp.dest('public/resources/adminlte/js'));
    // Bootstrap 5 JS (bundle includes Popper)
    pipeline(gulp.src('./node_modules/bootstrap/dist/js/bootstrap.bundle.min.js*'), gulp.dest('public/resources/adminlte/js'));
    // Font Awesome CSS
    pipeline(gulp.src('./node_modules/@fortawesome/fontawesome-free/css/all.min.css'), gulp.dest('public/resources/adminlte/fontawesome/css'));
    // Font Awesome webfonts
    pipeline(gulp.src('./node_modules/@fortawesome/fontawesome-free/webfonts/*.*', { encoding: false }), gulp.dest('public/resources/adminlte/fontawesome/webfonts'));
    // SweetAlert2
    return pipeline(gulp.src('./node_modules/sweetalert2/dist/sweetalert2.all.min.js'), gulp.dest('public/resources/adminlte/js'));
});
