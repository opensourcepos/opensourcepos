...
describe("test receiving quantity", function () {
  ...
  it("should be able to receive quantities with multiplier", function (done) {
    this.browser
      ...
      .clear()
      .type(item.name)
      .elementByCssSelector(".ui-autocomplete .ui-menu-item", def_timeout)
      .click()
      .elementByName("quantity")
      .elementByCssSelector("#cart_contents tr td:nth-child(5)")
      .text()
      .then(function (value) {
      ...
      .submit()
      .elementByCssSelector("#receipt_items tr:nth-child(2) td:nth-last-child(2)", def_timeout)
      .text()
      .then(function (value) {
