...
<head>
    ...
    <?php if (ENVIRONMENT == 'development' || get_cookie('debug') == 'true' || $request->getGet('debug') == 'true') : ?>
        ...
        <script src="resources/js/purify-522a90f29e.js"></script>
        <script src="resources/js/jspdf-92d87e47e8.plugin.autotable.js"></script>
        <script src="resources/js/xlsx-6b3130af1c.full.min.js"></script>
        ...
        <script src="resources/js/manage_tables-d7a5bcc853.js"></script>
        <script src="resources/js/nominatim-becb3f84b2.autocomplete.js"></script>
        <!-- endinject -->
    <?php else : ?>
        <!--inject:prod:css -->
        ...
        <script src="resources/opensourcepos-2c0ce690e5.min.js"></script>
        <!-- endinject -->
    <?php endif; ?>
