...
<?= form_open("attributes/saveDefinition/$definition_id", ['id' => 'attribute_form']) ?>
    ...
    <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" name="definition_name" id="definition_name" aria-describedby="definition_name-icon" value="<?= $definition_info->definition_name; ?>">
    </div>
    ...
    <div class="toggle-hide d-none">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="definition_unit" id="definition_unit" aria-describedby="definition_unit-icon" value="<?= $definition_info->definition_unit; ?>">
        </div>
    </div>
