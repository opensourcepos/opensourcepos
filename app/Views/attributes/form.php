...
<fieldset id="attribute_basic_info">
	...
	<div class="form-group form-group-sm">
		<?php echo form_label(lang('Attributes.definition_name'), 'definition_name', array('class'=>'required control-label col-xs-3')); ?>
		<div class='col-xs-8'>
	...
	<div class="form-group form-group-sm">
		<?php echo form_label(lang('Attributes.definition_type'), 'definition_type', array('class'=>'required control-label col-xs-3')); ?>
		<div class='col-xs-8'>
	...
	<div class="form-group form-group-sm">
		<?php echo form_label(lang('Attributes.definition_group'), 'definition_group', array('class' => 'control-label col-xs-3')); ?>
		<div class='col-xs-8'>
	...
	<div class="form-group form-group-sm hidden">
		<?php echo form_label(lang('Attributes.definition_flags'), 'definition_flags', array('class' => 'control-label col-xs-3')); ?>
		<div class='col-xs-8'>
			<div class="input-group">
				<?php echo form_multiselect('definition_flags[]', $definition_flags, array_keys($selected_definition_flags), array('id'=>'definition_flags', 'class'=>'selectpicker show-menu-arrow', 'data-none-selected-text'=>lang('Common.none_selected_text'), 'data-selected-text-format'=>'count > 1', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit')); ?>
			</div>
		</div>
	</div>

	<div class="form-group form-group-sm hidden">
		<?php echo form_label(lang('Attributes.definition_unit'), 'definition_units', array('class' => 'control-label col-xs-3')); ?>
		<div class='col-xs-8'>
			<div class="input-group">
	...
	<div class="form-group form-group-sm hidden">
		<?php echo form_label(lang('Attributes.definition_values'), 'definition_value', array('class' => 'control-label col-xs-3')); ?>
		<div class='col-xs-8'>
			<div class="input-group">
