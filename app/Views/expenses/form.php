...
<?= form_open("expenses/save/$expenses_info->expense_id", ['id' => 'expenses_edit_form', 'class' => '']) ?>
    <fieldset id="item_basic_info">

        <div class="row mb-3">
            <?= form_label(lang('Expenses.info'), 'expenses_info', ['class' => 'col-form-label col-3']) ?>
            <?= form_label(!empty($expenses_info->expense_id) ? lang('Expenses.expense_id') . " $expenses_info->expense_id" : '', 'expenses_info_id', ['class' => 'col-form-label col-8', 'style' => 'text-align: left']) ?>
        </div>

        <div class="row mb-3">
            <?= form_label(lang('Expenses.date'), 'date', ['class' => 'required col-form-label col-3']) ?>
            <div class="col-6">
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses.supplier_name'), 'supplier_name', ['class' => 'col-form-label col-3']) ?>
            <div class="col-6">
                <?= form_input([
                    'name'  => 'supplier_name',
                    'id'    => 'supplier_name',
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses.supplier_tax_code'), 'supplier_tax_code', ['class' => 'col-form-label col-3']) ?>
            <div class="col-6">
                <?= form_input([
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses.amount'), 'amount', ['class' => 'required col-form-label col-3']) ?>
            <div class="col-6">
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses.tax_amount'), 'tax_amount', ['class' => 'col-form-label col-3']) ?>
            <div class="col-6">
                <div class="input-group input-group-sm">
                    <?php if (!is_right_side_currency_symbol()): ?>
                        <span class="input-group-text input-sm"><b><?= esc($config['currency_symbol']) ?></b></span>
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses.payment'), 'payment_type', ['class' => 'col-form-label col-3']) ?>
            <div class="col-6">
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses_categories.name'), 'category', ['class' => 'col-form-label col-3']) ?>
            <div class="col-6">
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses.employee'), 'employee', ['class' => 'col-form-label col-3']) ?>
            <div class="col-6">
        ...
        <div class="row mb-3">
            <?= form_label(lang('Expenses.description'), 'description', ['class' => 'col-form-label col-3']) ?>
            <div class="col-6">
                <?= form_textarea([
                    'name'  => 'description',
                    'id'    => 'description',
        ...
        <?php if (!empty($expenses_info->expense_id)) { ?>
            <div class="row mb-3">
                <?= form_label(lang('Expenses.is_deleted') . ':', 'deleted', ['class' => 'col-form-label col-3']) ?>
                <div class="col-5">
                    <?= form_checkbox([
                        'name'    => 'deleted',
                        'id'      => 'deleted',
