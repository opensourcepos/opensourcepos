	...
	<fieldset id="item_basic_info">
		...
		<div class="form-group form-group-sm">
			...
			<div class="col-xs-8">
				...
				<?php
				if($this->appconfig->get('derive_sale_quantity') == '1')
				{
				?>
					<label class="radio-inline">
						<?php echo form_radio ([
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<?php echo form_input ([
						...
						'id' => 'tax_name_1',
						'class' => 'form-control input-sm',
						'value' => isset($item_tax_info[0]['name']) ? esc($item_tax_info[0]['name'], 'attr') : esc($this->appconfig->get('default_tax_1_name'), 'attr')
					]) ?>
				</div>
				<div class="col-xs-4">
					<div class="input-group input-group-sm">
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<?php echo form_input ([
						...
						'id' => 'tax_name_2',
						'class' => 'form-control input-sm',
						'value' => isset($item_tax_info[1]['name']) ? esc($item_tax_info[1]['name'], 'attr') : esc($this->appconfig->get('default_tax_2_name'), 'attr')
					]) ?>
				</div>
				<div class="col-xs-4">
					<div class="input-group input-group-sm">
