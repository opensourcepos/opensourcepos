	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_invoice_enable'), 'invoice_enable', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_invoice_type'), 'invoice_type', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-3'>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_recv_invoice_format'), 'recv_invoice_format', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
			...
			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_invoice_default_comments'), 'invoice_default_comments', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-5'>
			...
			<div class="form-group form-group-sm">	
				<?php echo form_label(lang('config_invoice_email_message'), 'invoice_email_message', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-5'>
					<?php echo form_textarea(array(
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_line_sequence'), 'line_sequence', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_sales_invoice_format'), 'sales_invoice_format', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_last_used_invoice_number'), 'last_used_invoice_number', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
						'type' => 'number',
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_sales_quote_format'), 'sales_quote_format', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_last_used_quote_number'), 'last_used_quote_number', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
						'type' => 'number',
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_quote_default_comments'), 'quote_default_comments', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-5'>
					<?php echo form_textarea(array(
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_work_order_enable'), 'work_order_enable', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_work_order_format'), 'work_order_format', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
			...
			<div class="form-group form-group-sm">
				<?php echo form_label(lang('config_last_used_work_order_number'), 'last_used_work_order_number', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_input(array(
						'type' => 'number',
