                ...
                <div class="col-xs-6">
                    <div class="fileinput <?= $logo_exists ? 'fileinput-exists' : 'fileinput-new' ?>" data-provides="fileinput">
                        ...
                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 200px;">
                            <img data-src="holder.js/100%x100%" alt="<?= lang('Config.company_logo') ?>" src="<?php if ($logo_exists) echo base_url('writable/uploads/' . $config['company_logo']); else echo '' ?>" style="max-height: 100%; max-width: 100%;">
                        </div>
                        <div>
