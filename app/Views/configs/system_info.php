...
<div id="config_wrapper" class="col-sm-12">
    ...
    <div class="container" id="issuetemplate">
        <!-- OSPOS Configuration-->
        <div class="row">
            <div class="col-sm-2" style="text-align: left;"><br>
                <strong>OSPOS Configuration</strong>
            </div>
            <div class="col-sm-8" style="text-align: left;"><br>
                <?= lang('Config.ospos_info') . ':' ?>
                <?= esc(config('App')->application_version) ?> - <?= esc(substr(config(OSPOS::class)->commit_sha1, 0, 6)) ?><br>
                Language Code: <?= current_language_code() ?><br>
                OSPOS Time Zone: <span id="ostimezone"><?= esc($config['timezone']) ?></span> <div id="TimeError"></div>
            </div>
        </div>
        ...
        <div class="row" style="margin-top:1em;">
            ...
            <div class="col-sm-8" style="text-align: left;">
                <strong>Extensions & Modules:</strong><br>
                <?php
                ...
                ?>
                <strong>User Configuration:</strong><br>
                .Browser:
                <?php
                /**
                ...
                .OS Time Zone: <span id="timezone"></span>
            </div>
        </div>
