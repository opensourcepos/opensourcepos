	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8" id="issuetemplate" align="left"><br>
				...
				<?php echo $this->config->get('application_version'); ?> - <?php echo substr($this->config->get('commit_sha1'), 0, 6); ?><br>
				...
				<div id="ostimezone" style="display:none;" ><?php echo $this->config->get('timezone'); ?></div><br>
				<br>	
			</div>
		</div>
	</div>
