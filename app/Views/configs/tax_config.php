	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_code', $tax_code_options, $this->config->get('default_tax_code'), ['class' => 'form-control input-sm')); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_category', $tax_category_options, $this->config->get('default_tax_category'), ['class' => 'form-control input-sm')); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_jurisdiction', $tax_jurisdiction_options, $this->config->get('default_tax_jurisdiction'), ['class' => 'form-control input-sm')); ?>
				</div>
			</div>
