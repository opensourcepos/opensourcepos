	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_input ([
						...
						'value' => $this->appconfig->get('tax_id'))); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_input ([
						...
						'class' => 'form-control input-sm',
						'value'=>$this->appconfig->get('default_tax_1_name')!==FALSE ? $this->appconfig->get('default_tax_1_name') : lang('Items.sales_tax_1'))); ?>
				</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_input ([
						...
						'class' => 'form-control input-sm',
						'value'=>$this->appconfig->get('default_tax_2_name')!==FALSE ? $this->appconfig->get('default_tax_2_name') : lang('Items.sales_tax_2'))); ?>
				</div>
				<div class="col-xs-1 input-group">
					<?php echo form_input ([
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_code', $tax_code_options, $this->appconfig->get('default_tax_code'), ['class' => 'form-control input-sm')); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_category', $tax_category_options, $this->appconfig->get('default_tax_category'), ['class' => 'form-control input-sm')); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_jurisdiction', $tax_jurisdiction_options, $this->appconfig->get('default_tax_jurisdiction'), ['class' => 'form-control input-sm')); ?>
				</div>
			</div>
