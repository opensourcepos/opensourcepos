	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_input ([
						...
						'value' => esc($this->appconfig->get('tax_id'), 'attr')
					]) ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_checkbox ([
						...
						'id' => 'tax_included',
						'value' => 'tax_included',
						'checked' => $this->appconfig->get('tax_included')
					]) ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_input ([
						...
						'class' => 'form-control input-sm',
						'value' => $this->appconfig->get('default_tax_1_name')!==FALSE ? esc($this->appconfig->get('default_tax_1_name'), 'attr') : lang('Items.sales_tax_1')]) ?>
				</div>
				<div class="col-xs-1 input-group">
					<?php echo form_input ([
						...
						'class' => 'form-control input-sm',
						'value' => to_tax_decimals($this->appconfig->get('default_tax_1_rate'))
					]) ?>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_input ([
						...
						'class' => 'form-control input-sm',
						'value' => $this->appconfig->get('default_tax_2_name')!==FALSE ? esc($this->appconfig->get('default_tax_2_name'), 'attr') : lang('Items.sales_tax_2')
					]) ?>
				</div>
				<div class="col-xs-1 input-group">
					<?php echo form_input ([
						...
						'class' => 'form-control input-sm',
						'value' => to_tax_decimals($this->appconfig->get('default_tax_2_rate'))
					]) ?>
					<span class="input-group-addon input-sm">%</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_checkbox ([
						...
						'checked' => $this->appconfig->get('use_destination_based_tax')
					]) ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_code', esc($tax_code_options, 'attr'), esc($this->appconfig->get('default_tax_code'), 'attr'), ['class' => 'form-control input-sm']) ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_category', esc($tax_category_options, 'attr'), esc($this->appconfig->get('default_tax_category'), 'attr'), ['class' => 'form-control input-sm']) ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('default_tax_jurisdiction', esc($tax_jurisdiction_options, 'attr'), esc($this->appconfig->get('default_tax_jurisdiction'), 'attr'), ['class' => 'form-control input-sm']) ?>
				</div>
			</div>
