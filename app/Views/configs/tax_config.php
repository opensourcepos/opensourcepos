    ...
    <div class="row">
        <div class="col-12 col-lg-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" min="0" max="100" class="form-control" id="default_tax_1_rate" name="default_tax_1_rate" value="<?= to_tax_decimals($config['default_tax_1_rate']) ?>">
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" min="0" max="100" class="form-control" id="default_tax_2_rate" name="default_tax_2_rate" value="<?= to_tax_decimals($config['default_tax_2_rate']) ?>">
                <label class="input-group-text"><i class="bi bi-percent"></i></label>
            </div>
        </div>
    </div>
