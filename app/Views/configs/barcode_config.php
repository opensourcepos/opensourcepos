	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('barcode_type', esc($support_barcode), $this->config->get('barcode_type'), ['class' => 'form-control input-sm']); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-sm-2'>
					<?php echo form_dropdown('barcode_font',
						...
						esc($this->config->get('barcode_font')), ['class' => 'form-control input-sm required']);
						?>
				</div>
				<div class="col-sm-2">
					<?php echo form_input ([
					...
					<div class="form-group form-group-sm row">
						...
						<div class='col-sm-2'>
							<?php echo form_dropdown(
								...
								$this->config->get('barcode_first_row'), ['class' => 'form-control input-sm']);
							?>
						</div>
						...
						<div class='col-sm-2'>
							...
							$this->config->get('barcode_second_row'), ['class' => 'form-control input-sm']); ?>
						</div>
						...
						<div class='col-sm-2'>
							...
							$this->config->get('barcode_third_row'), ['class' => 'form-control input-sm']); ?>
						</div>
					</div>
				</div>
			</div>
