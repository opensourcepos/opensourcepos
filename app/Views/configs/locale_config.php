	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				...
				<div class='row'>
					<div class='col-xs-1'>
						<?php echo form_input('number_locale', $this->config->get('number_locale'), ['class' => 'form-control input-sm', 'id' => 'number_locale')); ?>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('currency_decimals', [
						'0' => '0',
						'1' => '1',
						'2' => '2'
					),
					$this->config->get('currency_decimals'), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('tax_decimals', [
						'0' => '0',
						'1' => '1',
						'2' => '2',
						'3' => '3',
					...
					$this->config->get('tax_decimals'), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('quantity_decimals', [
						'0' => '0',
						'1' => '1',
						'2' => '2',
						'3' => '3'
					),
					$this->config->get('quantity_decimals'), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('cash_decimals', [
						'-1' => '-1',
						'0' => '0',
						'1' => '1',
						'2' => '2'
					),
						$this->config->get('cash_decimals'), ['class' => 'form-control input-sm'));
					?>
				</div>
				<div class='col-xs-1'>
					<label class="control-label">
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('cash_rounding_code', $rounding_options, $this->config->get('cash_rounding_code'), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<?php echo form_dropdown('payment_options_order', [
					...
					$this->config->get('payment_options_order'), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-1'>
					<?php echo form_input('country_codes', $this->config->get('country_codes'), ['class' => 'form-control input-sm')); ?>
				</div>
				<div class="col-xs-1">
					<label class="control-label">
			...
			<?php echo form_label(lang('Config.timezone'), 'timezone', ['class' => 'control-label col-xs-2')); ?>
				...
				<?php echo form_dropdown(
					'timezone',
					get_timezones(),
					$this->config->get('timezone') ? $this->config->get('timezone') : date_default_timezone_get(), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<?php echo form_label(lang('Config.datetimeformat'), 'datetimeformat', ['class' => 'control-label col-xs-2')); ?>
				...
				<?php echo form_dropdown('dateformat',
					get_dateformats(),
					$this->config->get('dateformat'), ['class' => 'form-control input-sm'));
					?>
				</div>
				<div class='col-sm-2'>
				<?php echo form_dropdown('timeformat',
					get_timeformats(),
					$this->config->get('timeformat'), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-2'>
					<?php echo form_dropdown('financial_year', [
					...
					$this->config->get('financial_year'), ['class' => 'form-control input-sm'));
					?>
				</div>
			</div>
