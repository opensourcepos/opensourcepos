...
<?= form_open('config/saveLocale/', ['id' => 'locale_config_form']) ?>
    ...
    <div class="row">
        <div class="col-12 col-lg-6">
            <label for="payment_reference_code_length" class="form-label"><?= lang('Config.payment_reference_code_length_limits') ?></label>
            <div id="payment_reference_code_slider"></div>
            <div class="d-flex justify-content-between">
                <output for="payment_reference_code_max">
                    <span><?= lang('Config.payment_reference_code_length_min_label') ?>: </span>
                ...
                <output for="payment_reference_code_min">
                    <span><?= lang('Config.payment_reference_code_length_max_label') ?>: </span>
