...
<div class="container-fluid">
    <ul class="nav nav-tabs" id="myTabs" data-toggle="tab">
        ...
        <li><a href="#integrations_tabs" data-toggle="tab" title="<?= lang('Config.plugins_configuration') ?>"><?= lang('Config.plugins') ?></a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="integrations_tabs"><?= view('configs/plugins_config') ?></div>
