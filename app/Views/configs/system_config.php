...
<div class="container-fluid">
    <ul class="nav nav-tabs" id="myTabs" data-toggle="tab">
        ...
        <li><a href="#whatsapp_tabs" data-toggle="tab" title="<?= lang('Config.whatsapp_configuration') ?>"><?= lang('Config.whatsapp') ?></a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="whatsapp_tabs"><?= view('configs/whatsapp_config') ?></div>
