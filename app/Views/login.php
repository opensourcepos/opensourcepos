...
<head>
  <meta charset="utf-8">
	...
	<title><?php echo $this->config->item('company') . '&nbsp;|&nbsp;' . lang('Common.software_short')  . '&nbsp;|&nbsp;' .  lang('Login.login'); ?></title>
  ...
  <main class="d-flex justify-content-around align-items-center flex-grow-1">
    <div class="container-login container-fluid d-flex flex-column flex-md-row bg-body shadow rounded m-3 p-4 p-md-0">
      ...
      <?php if ($this->Appconfig->get('company_logo')): ?>
        <img class="logo w-100" src="<?php echo base_url('uploads/' . $this->Appconfig->get('company_logo')); ?>" alt="<?php echo lang('Common.logo') . '&nbsp;' . $this->config->item('company'); ?>">
      <?php else: ?>
      ...
      <section class="box-login d-flex flex-column justify-content-center align-items-center p-md-4">
        ...
        <div class="alert alert-info mt-3">
					<?php echo lang('Login.migration_needed', $this->config->item('application_version')); ?>
				</div>
				<?php endif; ?>
