<div id="receipt_wrapper" style="width:100%;">
	...
	<table id="receipt_items" style="text-align:left;width:100%;">
		<tr>
			...
			<th style="width:20%;text-align:right;"><?php echo lang('sales_total'); ?></th>
		</tr>
		<?php
		...
		?>
			...
			<tr>
				<td colspan="3" style="text-align:right;"><?php echo lang('sales_discount'); ?>:</td>
		...
		<tr>
			<td colspan="3" style="<?php echo $border? 'border-top: 2px solid black;' :''; ?>text-align:right;"><?php echo lang('sales_total'); ?></td>
