...
<div class="print_hide" id="control_buttons" style="text-align:right">
	...
	<?php if(!empty($customer_email)): ?>
		<a href="javascript:void(0);"><div class="btn btn-info btn-sm", id="show_email_button"><?php echo '<span class="glyphicon glyphicon-envelope">&nbsp</span>' . lang('sales_send_receipt'); ?></div></a>
	<?php endif; ?>
...
<?php echo view("sales/" . $this->config->item('receipt_template')); ?>
