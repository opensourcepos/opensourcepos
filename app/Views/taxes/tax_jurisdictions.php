...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		var add_tax_jurisdiction = function() {
			...
			$(new_block).find('label').html("<?php echo lang('Taxes.tax_jurisdiction') ?> " + tax_jurisdictions_count).attr('for', new_jurisdiction_name_id).attr('class', 'control-label col-xs-2');
		...
		$.validator.addMethod('check4TaxJurisdictionDups' , function(value, element) {
			...
			return true;
		}, "<?php echo lang('Taxes.tax_jurisdiction_duplicate') ?>");
		...
		$.validator.addMethod('validateTaxJurisdictionCharacters', function(value, element) {
			...
			return true;
		}, "<?php echo lang('Taxes.tax_jurisdiction_invalid_chars') ?>");
		...
		$.validator.addMethod('requireTaxJurisdiction', function(value, element) {
			...
			return true;
		}, "<?php echo lang('Taxes.tax_jurisdiction_required') ?>");
