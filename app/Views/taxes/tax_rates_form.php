...
<?php echo form_open('taxes/save/'.$tax_rate_id, array('id'=>'tax_code_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="tax_rate_info">
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('taxes_tax_code'), 'rate_tax_code_id', array('class' => 'control-label col-xs-3')); ?>
			<div class='col-xs-5'>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('taxes_tax_category'), 'rate_tax_category_id', array('class' => 'control-label col-xs-3')); ?>
			<div class='col-xs-5'>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('taxes_tax_jurisdiction'), 'rate_jurisdiction_id', array('class' => 'control-label col-xs-3')); ?>
			<div class='col-xs-5'>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('taxes_tax_rate'), 'tax_rate', array('class'=>'control-label col-xs-3')); ?>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label(lang('taxes_tax_rounding'), 'tax_rounding_code', array('class' => 'control-label col-xs-3')); ?>
			<div class='col-xs-5'>
