...
class Migration_Attributes_fix_cascading_delete extends Migration
{
	...
	{
		$this->db->query("ALTER TABLE `ospos_attribute_links` DROP FOREIGN KEY `ospos_attribute_links_ibfk_1`");
		...
		$this->db->query("ALTER TABLE `ospos_attribute_links` DROP FOREIGN KEY `ospos_attribute_links_ibfk_2`");
