...
ALTER TABLE `ospos_sales_suspended_payments` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_payments_ibfk_1`;

ALTER TABLE `ospos_sales_suspended_items_taxes` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_items_taxes_ibfk_1`;
ALTER TABLE `ospos_sales_suspended_items_taxes` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_items_taxes_ibfk_2`;

ALTER TABLE `ospos_sales_suspended_items` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_items_ibfk_1`;
ALTER TABLE `ospos_sales_suspended_items` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_items_ibfk_2`;
ALTER TABLE `ospos_sales_suspended_items` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_items_ibfk_3`;

ALTER TABLE `ospos_sales_suspended` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_ibfk_1`;
ALTER TABLE `ospos_sales_suspended` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_ibfk_2`;
ALTER TABLE `ospos_sales_suspended` DROP FOREIGN KEY IF EXISTS `ospos_sales_suspended_ibfk_3`;
