...
class Attribute extends Model
{
    ...
    public function deleteAttributeLinks(int $item_id, bool|int $definition_id = false): bool
    {
    ...
    public function saveAttributeValue(string $attribute_value, int $definition_id, bool|int $item_id = false, bool|int $attribute_id = false, string $definition_type = DROPDOWN): int
    {
        $config = config(OSPOS::class)->settings;
