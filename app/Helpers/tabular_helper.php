...
function get_items_manage_table_headers(array $stock_locations = []): string
{
    ...
    $headers = array_values(array_filter($headers, static fn (array $header): bool => ! array_key_exists('quantity', $header)));
    ...
    array_splice($headers, $position, 0, [['total' => lang('Items.all_branches'), 'sortable' => false]]);
