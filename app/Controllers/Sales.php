...
class Sales extends Secure_Controller
{
    ...
    private function _load_sale_data($sale_id): array    // TODO: Hungarian notation
    {
        ...
        // Build per-item tax map for UBL generation
        helper('country');
        $data['item_taxes']    = $this->sale->get_sale_item_taxes_by_sale($sale_id);
        $data['tax_included']  = (bool) $this->config['tax_included'];
        $data['currency_code'] = getCurrencyCode(getCountryCode($this->config['country'] ?? ''));
