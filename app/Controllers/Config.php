...
class Config extends Secure_Controller
{
    ...
    public function postSaveGeneral(): void
    {
        $batch_save_data = [
            ...
            'turnstile_enable'                  => $this->request->getPost('turnstile_enable') != null,
            'turnstile_secret_key'              => $this->request->getPost('turnstile_secret_key'),
            'turnstile_site_key'                => $this->request->getPost('turnstile_site_key'),
