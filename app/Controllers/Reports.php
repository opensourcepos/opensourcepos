...
class Reports extends Secure_Controller
{
     ...
     * @return void
     */
    public function summary_sales(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string    // TODO: Perhaps these need to be passed as an array?  Too many parameters in the signature.
     ...
     * @return void
     */
    public function summary_categories(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated code
        $this->clearCache();
     ...
     * @return void
     */
    public function summary_expenses_categories(string $start_date, string $end_date, string $sale_type): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function summary_customers(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function summary_suppliers(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @return void
     */
    public function summary_items(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function summary_employees(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function summary_taxes(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicate Code
        $this->clearCache();
     ...
     */
    public function summary_sales_taxes(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated code
        $this->clearCache();
     ...
     */
    public function summary_discounts_input(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     **/
    public function summary_discounts(string $start_date, string $end_date, string $sale_type, string $location_id = 'all', int $discount_type = 0): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     */
    public function summary_payments(string $start_date, string $end_date): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function date_input(): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function date_input_only(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function date_input_sales(): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function date_input_recv(): ResponseInterface|string
    {
     ...
     * @noinspection PhpUnused
     */
    public function graphical_summary_expenses_categories(string $start_date, string $end_date, string $sale_type): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_sales(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_items(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_categories(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_suppliers(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_employees(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_taxes(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_sales_taxes(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_customers(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function graphical_summary_discounts(string $start_date, string $end_date, string $sale_type, string $location_id = 'all', int $discount_type = 0): ResponseInterface|string
    {   // TODO: Duplicated Code
        $this->clearCache();
     ...
     * @return void
     */
    public function graphical_summary_payments(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function specific_customer_input(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function specific_customers(string $start_date, string $end_date, string $customer_id, string $sale_type, string $payment_type): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function specific_employee_input(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function specific_employees(string $start_date, string $end_date, string $employee_id, string $sale_type): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function specific_discount_input(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function specific_discounts(string $start_date, string $end_date, string $discount, string $sale_type, string $discount_type): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function getGet_detailed_sales_row(string $sale_id): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function specific_supplier_input(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function specific_suppliers(string $start_date, string $end_date, string $supplier_id, string $sale_type): ResponseInterface|string
    {
        $inputs = [
            'start_date'  => $start_date,
            'end_date'    => $end_date,
     ...
     * @return void
     */
    public function detailed_sales(string $start_date, string $end_date, string $sale_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function getGet_detailed_receivings_row(string $receiving_id): ResponseInterface|string
    {
     ...
     * @return void
     */
    public function detailed_receivings(string $start_date, string $end_date, string $receiving_type, string $location_id = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function inventory_low(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @noinspection PhpUnused
     */
    public function inventory_summary_input(): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    public function inventory_summary(string $location_id = 'all', string $item_count = 'all'): ResponseInterface|string
    {
        $this->clearCache();
     ...
     * @return void
     */
    private function clearCache(): ResponseInterface|string
    {
