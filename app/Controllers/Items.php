...
class Items extends Secure_Controller
{
     ...
     * @noinspection PhpUnused
     */
    public function getPicThumb(string $pic_filename): ResponseInterface|string
    {
        helper('file');
     ...
     * @noinspection PhpUnused
     */
    public function getSuggestLowSell(): ResponseInterface|string
    {
     ...
     * @noinspection PhpUnused
     */
    public function getSuggestKits(): ResponseInterface|string
    {
     ...
     * @noinspection PhpUnused
     */
    public function getSuggestLocation(): ResponseInterface|string
    {
     ...
     * @return void
     */
    public function getRow(string $item_ids): ResponseInterface|string    // TODO: An array would be better for parameter.
    {
     ...
     * @return void
     */
    public function getView(int $item_id = NEW_ENTRY): ResponseInterface|string    // TODO: Long function. Perhaps we need to refactor out some methods.
    {
        $item_id ??= NEW_ENTRY;
     ...
     * @noinspection PhpUnused
     */
    public function getInventory(int $item_id = NEW_ENTRY): ResponseInterface|string
    {
     ...
     * @noinspection PhpUnused
     */
    public function getCountDetails(int $item_id = NEW_ENTRY): ResponseInterface|string
    {
        $item_info = $this->item->get_info($item_id);    // TODO: Duplicate code
     ...
     * @noinspection PhpUnused
     */
    public function getGenerateBarcodes(string $item_ids): ResponseInterface|string    // TODO: Passing these through as a string instead of an array limits the contents of the item_ids. Perhaps a better approach would to serialize as JSON in an array and pass through post variables?
    {
     ...
     * @return void
     */
    public function getAttributes(int $item_id = NEW_ENTRY): ResponseInterface|string
    {
     ...
     * @noinspection PhpUnused
     */
    public function postAttributes(int $item_id = NEW_ENTRY): ResponseInterface|string
    {
        $data['item_id'] = $item_id;
     ...
     * @noinspection PhpUnused
     */
    public function getBulkEdit(): ResponseInterface|string
    {
        $suppliers = ['' => lang('Items.none')];
     ...
     */
    public function postSave(int $item_id = NEW_ENTRY): ResponseInterface|string
    {
     ...
     * @return void
     */
    public function check_kit_exists(): ResponseInterface|string    // TODO: This function appears to be never called in the code.  Need to confirm.
    {
     ...
     * @noinspection PhpUnused
     */
    public function getRemoveLogo($item_id): ResponseInterface|string
    {
     ...
     * @noinspection PhpUnused
     */
    public function postSaveInventory($item_id = NEW_ENTRY): ResponseInterface|string
    {
        $employee_id = $this->employee->get_logged_in_employee_info()->person_id;
     ...
     * @noinspection PhpUnused
     */
    public function postBulkUpdate(): ResponseInterface|string
    {
