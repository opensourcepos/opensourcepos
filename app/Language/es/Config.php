...
return [
	...
	"derive_sale_quantity_tooltip" => "Si se marca, se proporcionará un nuevo tipo para los artículos ordenados por cantidad extendida",
	"dinner_table" => "Mesa",
	...
	"fax" => "Fax",
	"file_perm" => "Hay problemas con los permisos de archivo por favor corrija y vuelva a cargar esta página.",
