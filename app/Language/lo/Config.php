<?php
return [
	"config_address" => "ທີ່ຢູ່ບໍລິສັດ",
	"config_address_required" => "ກະລຸນາໃສ່ທີ່ຢູ່ບໍລິສັດ.",
	"config_all_set" => "All file permissions are set correctly!",
	"config_allow_duplicate_barcodes" => "ອະນຸຍາດໃຫ້ມີບາໂຄດຊໍ້າກັນ",
	"config_apostrophe" => "ຈຸດລາຍນໍ້າ",
	"config_backup_button" => "ການສຳຮອງ",
	"config_backup_database" => "ການສຳຮອງຖານຂໍ້ມູນ",
	"config_barcode" => "ບາໂຄດ",
	"config_barcode_company" => "ຊື່ບໍລິສັດ",
	"config_barcode_configuration" => "ການຕັ້ງຄ່າກ່ຽວກັບ Barcode",
	"config_barcode_content" => "ເນື່ອຫາຂອງ Barcode",
	"config_barcode_first_row" => "ແຖວທີ 1",
	"config_barcode_font" => "ຟອນທ໌",
	"config_barcode_formats" => "ຮູບແບບການໃສ່ຂໍ້ມູນ",
	"config_barcode_generate_if_empty" => "ສ້າງຖ້າວ່າງເປົ່າ.",
	"config_barcode_height" => "ສູງ (px)",
	"config_barcode_id" => "ລະຫັດສິນຄ້າ/ຊື່ສິນຄ້າ",
	"config_barcode_info" => "ຂໍ້ມູນການຕັ້ງຄ່າກ່ຽວກັບ Barcode",
	"config_barcode_layout" => "ການຈັດລຽງຮູບແບບ Barcode",
	"config_barcode_name" => "ຊື່ສິນຄ້າ",
	"config_barcode_number" => "ລະຫັດ Barcode",
	"config_barcode_number_in_row" => "ຈຳນວນແຖວທີ່ໃຊ້",
	"config_barcode_page_cellspacing" => "Display page cellspacing.",
	"config_barcode_page_width" => "Display page width",
	"config_barcode_price" => "ລາຄາ",
	"config_barcode_second_row" => "ແຖວທີ 2",
	"config_barcode_third_row" => "ແຖວທີ 3",
	"config_barcode_tooltip" => "ຄຳເຕືອນ: This feature can cause duplicate items to be imported or created.  Do not use if you do not want duplicate barcodes.",
	"config_barcode_type" => "ປະເພດ Barcode",
	"config_barcode_width" => "ຄວາມກວ້າງ (px)",
	"config_bottom" => "ດ້ານລຸ່ມຂອງເຈ້ຍ",
	"config_cash_button" => "",
	...
	"config_cash_decimals" => "ຈຳນວນຕົວເລກເສດເງິນ",
	"config_cash_decimals_tooltip" => "ກະລຸນາປັບຈຳນວນຕົວເລກເສດໃຫ້ເທົ່າກັນເພື່ອຈະໄດ້ບໍ່ມີການປັດມູນຄ່າເງິນ.",
	"config_cash_rounding" => "ການປັດມູນຄ່າເງິນ",
	"config_category_dropdown" => "",
	"config_center" => "ທາງກາງຂອງເຈ້ຍ",
	"config_change_apperance_tooltip" => "",
	"config_comma" => "ເຄື່ອງຫມາຍຈຸດ",
	"config_company" => "ຊື່ບໍລິສັດ",
	"config_company_avatar" => "",
	"config_company_change_image" => "ປ່ຽນຮູບ",
	"config_company_logo" => "Logo ບໍລິສັດ",
	"config_company_remove_image" => "ລຶບຮູບ",
	"config_company_required" => "ກະລຸນາໃສ່ຊື່ບໍລິສັດ",
	"config_company_select_image" => "ກະລຸນາເລືອກຮູບ",
	"config_company_website_url" => "ທີ່ຢູ່ website ຂອງບໍລິສັດບໍ່ຖືກຕ້ອງ URL (http://...).",
	"config_country_codes" => "ລະຫັດປະເທດ",
	"config_country_codes_tooltip" => "ໃຊ້ເຄື່ອງຫມາຍຈຸດເພື່ອແຍກຫົວຫນ່ວຍເງິນຕາ",
	"config_currency_code" => "",
	"config_currency_decimals" => "ຈຳນວນຕົວເລກເສດເງິນ",
	"config_currency_symbol" => "ສັນຍະລັກຂອງເງິນ",
	"config_current_employee_only" => "",
	"config_customer_reward" => "ລາງວັນ",
	"config_customer_reward_duplicate" => "ລາງວັນສຳຫລັບລູກຄ້າຕ້ອງມີຄວາມແຕກຕ່າງ",
	"config_customer_reward_enable" => "ໃຊ້ງານລະບົບລາງວັນສຳຫລັບລູກຄ້າ",
	"config_customer_reward_invalid_chars" => "ລາງວັນບໍ່ສາມາດບັນຈຸໄດ້ '_'",
	"config_customer_reward_required" => "ກະລຸນາກຳນົດລາງວັນ",
	"config_customer_sales_tax_support" => "ເປີດໃຊ້ອາກອນຊົມໃຊ້",
	"config_date_or_time_format" => "Date and Time Filter",
	"config_datetimeformat" => "ຮູບແບບວັນທີ່ ແລະ ເວລາ",
	"config_decimal_point" => "ເຄື່ອງຫມາຍເລກເສດເງິນ",
	"config_default_barcode_font_size_number" => "ຂະຫນາດຂອງຕົວອັກສອນຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_barcode_font_size_required" => "ກະລຸນາໃສ່ຂະຫນາດຂອງຕົວອັກສອນ.",
	"config_default_barcode_height_number" => "ຂະຫນາດຄວາມສູງຂອງ Barcode ຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_barcode_height_required" => "ກະລຸນາໃສ່ຂະຫນາດຄວາມສູງຂອງ Barcode.",
	"config_default_barcode_num_in_row_number" => "ຈຳນວນແຖວຂອງ Barcode ຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_barcode_num_in_row_required" => "ກະລຸນາໃສ່ຈຳນວນແຖວຂອງ Barcode.",
	"config_default_barcode_page_cellspacing_number" => "ຄວາມຫ່າງລະຫວ່າງຫ້ອງຂໍ້ມູນຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_barcode_page_cellspacing_required" => "ກະລຸນາໃສ່ຄວາມຫ່າງລະຫວ່າງຫ້ອງຂໍ້ມູນ.",
	"config_default_barcode_page_width_number" => "ຄວາມກວ້າງຂອງຫນ້າ Barcode ຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_barcode_page_width_required" => "ກະລຸນາໃສ່ຄວາມກວ້າງຂອງຫນ້າ Barcode.",
	"config_default_barcode_width_number" => "ຄວາມກວ້າງຂອງ Barcode ຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_barcode_width_required" => "ກະລຸນາກຳນົດຄວາມກວ້າງຂອງ Barcode.",
	"config_default_item_columns" => "",
	"config_default_origin_tax_code" => "ທີ່ມາຂອງອາກອນ",
	"config_default_receivings_discount" => "",
	"config_default_receivings_discount_number" => "",
	"config_default_receivings_discount_required" => "",
	"config_default_sales_discount" => "ເປີເຊັນສ່ວນຫລຸດ %",
	"config_default_sales_discount_number" => "ເປເຊັນສ່ວນຫລຸດ ຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_sales_discount_required" => "ກະລຸນາກຳນົດເປີເຊັນສ່ວນຫລຸດ.",
	"config_default_tax_category" => "",
	"config_default_tax_code" => "",
	"config_default_tax_jurisdiction" => "",
	"config_default_tax_name_number" => "ຊື່ຂອງອາກອນຕ້ອງເປັນຕົວອັກສອນ.",
	"config_default_tax_name_required" => "ກະລຸນາໃສ່ຊື່ອາກອນ.",
	"config_default_tax_rate" => "ອັດຕາອາກອນ %",
	"config_default_tax_rate_1" => "ອັດຕາອາກອນທີ 1",
	"config_default_tax_rate_2" => "ອັດຕາອາກອນທີ 2",
	"config_default_tax_rate_3" => "",
	"config_default_tax_rate_number" => "ອັດຕາອາກອນ ຕ້ອງເປັນຕົວເລກເທົ່ານັ້ນ.",
	"config_default_tax_rate_required" => "ກະລຸນາກຳນົດອັດຕາອາກອນ.",
	"config_derive_sale_quantity" => "",
	"config_derive_sale_quantity_tooltip" => "",
	"config_dinner_table" => "ໂຕະສຳຫລັບຮ້ານອາຫານ",
	"config_dinner_table_duplicate" => "ເລກໂຕະຕ້ອງບໍ່ຊໍ້າກັນ.",
	"config_dinner_table_enable" => "ເປີດໃຊ້ງານລະບົບໂຕະສຳລັບຮ້ານອາຫານ",
	"config_dinner_table_invalid_chars" => "ບໍ່ສາມາດໃສ່ຊື່ໂຕະທີ່ມີ '_' ນີ້ໄດ້.",
	"config_dinner_table_required" => "ກະລຸນາກຳນົດຊື່ໂຕະ.",
	"config_dot" => "ຈໍ້າເມັດ",
	"config_email" => "Email",
