...
return [
	...
	"customers_confirm_delete" => "Are you sure you want to delete the selected Supplier(s)?",
	"customers_confirm_restore" => "Are you sure you want to restore selected Supplier(s)?",
	...
	"customers_error_adding_updating" => "Employee add or update failed.",
	...
	"customers_none_selected" => "You have not selected any employee(s) to delete.",
	"customers_one_or_multiple" => "customer(s)",
	"customers_quantity" => "Quantity",
	"customers_stats_info" => "Stats",
	"customers_successful_adding" => "You have successfully updated customer",
	"customers_successful_deleted" => "You have successfully deleted",
	"customers_successful_updating" => "You have successfully added customer",
