...
return [
	...
	"suppliers_none_selected" => "You have not selected any employee(s) to delete.",
	"suppliers_one_or_multiple" => "Supplier(s)",
	"suppliers_successful_adding" => "You have successfully updated Supplier",
	"suppliers_successful_deleted" => "You have successfully deleted",
	"suppliers_successful_updating" => "You have successfully added Supplier",
