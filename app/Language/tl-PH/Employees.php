...
return [
	...
	"employees_confirm_delete" => "Are you sure you want to delete the selected Supplier(s)?",
	"employees_confirm_restore" => "Are you sure you want to restore selected entry(s)?",
	...
	"employees_error_deleting_demo_admin" => "You can not change the demo admin user.",
	"employees_error_updating_demo_admin" => "You can not delete the demo admin user.",
	...
	"employees_password_minlength" => "Username must be at least 5 characters in length.",
	...
	"employees_successful_updating" => "You have successfully added customer",
	...
	"employees_username_minlength" => "Password must be at least 8 characters in length.",
