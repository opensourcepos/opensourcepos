...
return [
	...
	"attributes_confirm_delete" => "Are you sure you want to restore the selected attribute(s)?",
	"attributes_confirm_restore" => "Are you sure you want to delete the selected attribute(s)?",
	...
	"attributes_definition_name_required" => "Attribute type is a required field",
	...
	"attributes_definition_successful_updating" => "You have successfully updated Item Kit",
	"attributes_definition_type" => "Attribute Type",
	"attributes_definition_type_required" => "Attribute name is a required field",
