...
return [
	...
	"giftcards_cannot_be_deleted" => "Could not delete selected customers, one or more of the selected customers has sales.",
	...
	"giftcards_confirm_restore" => "Are you sure you want to delete the selected Gift Card(s)?",
