...
return [
    ...
    "requisitions_desc"          => "Request stock between locations with two-step approval.",
    "rmas"                       => "Returns (RMA)",
    "rmas_desc"                  => "Process return merchandise authorizations for stock and client units.",
    "sales"                      => "Sales",
