...
return [
    ...
    "discount_percent_exceeds_100"     => "Discount percent cannot exceed 100.",
    "discount_exceeds_item_total"      => "Discount cannot exceed item total.",
    "negative_total_invalid"           => "Total cannot be negative.",
