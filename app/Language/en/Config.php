...
return [
    ...
    "scale_sync_button"                        => "Enable Weighted Items",
    "scale_export_format"                      => "Scale Export Format",
    "scale_export_charset"                     => "Scale Export Charset",
    "scale_export_delimiter"                   => "Scale Export Delimiter",
    "scale_export_fields"                      => "Scale Export Fields",
    "shortcuts"                                 => "Shortcuts",
    "shortcuts_configuration"                   => "Sales Shortcut Configuration",
