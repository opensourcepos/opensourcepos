...
return [
    ...
    "whatsapp_token_required"                   => "Access Token is a required field",
    "whatsapp_api_url"                          => "API Base URL",
    "whatsapp_api_version"                      => "API Version",
    "whatsapp_default_country_code"             => "Default Country Code",
    "whatsapp_default_country_code_placeholder" => "e.g. 1",
    "whatsapp_msg"                              => "Saved Text Message",
    "whatsapp_msg_placeholder"                  => "Default message pre-filled on the WhatsApp send page. Leave blank for none.",
    "whatsapp_webhook_heading"                  => "Webhook (inbound replies)",
    "whatsapp_webhook_url"                      => "Callback URL",
    "whatsapp_webhook_url_help"                 => "Register this URL in the Meta app dashboard. It must be publicly reachable over HTTPS to receive replies.",
    "whatsapp_verify_token"                     => "Verify Token",
    "whatsapp_app_secret"                       => "App Secret",
    "whatsapp_window_notice"                    => "Note: free-form messages are only delivered within 24 hours of the customer's last message. Outside that window Meta requires an approved message template.",
