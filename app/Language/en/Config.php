...
return [
    ...
    "turnstile_enable"                          => "Login Page Turnstile",
    "turnstile_secret_key"                      => "Turnstile Secret Key",
    "turnstile_secret_key_required"             => "Turnstile Secret Key is a required field",
    "turnstile_site_key"                        => "Turnstile Site Key",
    "turnstile_site_key_required"               => "Turnstile Site Key is a required field",
    "turnstile_tooltip"                         => "Protect the Login page with Cloudflare Turnstile, click the icon for an API key pair.",
    "general"                                   => "General",
