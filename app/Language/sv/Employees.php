...
return [
    ...
    'cannot_be_deleted'                      => 'Det går inte att radera valda anställda, en eller flera av dem har behandlat försäljningar eller du försöker radera ditt konto.',
    'change_employee'                        => '',
    ...
    'error_cannot_remove_own_minimum_grant'  => 'Du kan inte ta bort dina egna minimibehörigheter för moduler.',
    'error_deleting_admin'                   => '',
    'error_deleting_demo_admin'              => 'Du kan inte radera demo admin-användaren.',
    'error_grant_change_disallowed'          => 'Behörighetsändringar är inaktiverade i denna demo.',
    'error_password_change_disallowed'       => 'Lösenordsändringar är inaktiverade i denna demo.',
