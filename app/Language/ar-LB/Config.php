...
return [
    ...
    "secondary_currency_disabled"               => "العملة الثانوية غير مفعّلة.",
    "secondary_currency_auto_enable"            => "تحديث تلقائي للعملة الثانوية",
    "secondary_currency_auto_enable_tooltip"    => "عند التفعيل، يقوم التطبيق بتحديث سعر العملة الثانوية من المصدر المحدد وفق جدول زمني.",
    "secondary_currency_auto_refresh_disabled"   => "التحديث التلقائي للعملة الثانوية غير مفعّل.",
    "secondary_currency_auto_refresh_disabled_force" => "التحديث التلقائي للعملة الثانوية غير مفعّل. استخدم --force للتشغيل رغم ذلك.",
    "secondary_currency_base_quote_required"    => "رمز العملة الثانوية مطلوب.",
    "secondary_currency_codes_required"         => "رموز العملات مطلوبة قبل تحديث السعر.",
    "secondary_currency_codes_must_differ"      => "يجب أن يكون رمز العملة الأساسية ورمز العملة الثانوية مختلفين.",
    "secondary_currency_feed_http_error"        => "أعاد مصدر العملة رمز HTTP {0}.",
    "secondary_currency_feed_invalid_json"      => "استجابة مصدر العملة ليست JSON صالحًا.",
    "secondary_currency_feed_invalid_rate"      => "لم يحتوِ مصدر العملة على سعر صالح لـ {0}.",
    "secondary_currency_feed_request_failed"    => "فشل طلب مصدر العملة: {0}",
    "secondary_currency_feed_url"               => "رابط مصدر العملة",
    "secondary_currency_feed_url_tooltip"       => "استخدم {base} لرمز العملة الأساسية و {quote} لرمز العملة الثانوية.",
    "secondary_currency_last_error"             => "آخر خطأ في التحديث",
    "secondary_currency_last_synced_at"         => "آخر تحديث",
    "secondary_currency_refresh_failed"         => "فشل تحديث العملة.",
    "secondary_currency_refresh_successful"     => "تم تحديث سعر العملة الثانوية بنجاح.",
    "secondary_currency_refresh_interval"       => "فاصل التحديث (بالدقائق)",
    "secondary_currency_refresh_interval_tooltip" => "كل كم دقيقة يجب أن يجلب عمل الخلفية سعرًا جديدًا.",
    "secondary_currency_refresh_interval_invalid" => "يجب أن يكون فاصل تحديث العملة الثانوية بين 1 و 1440 دقيقة.",
    "secondary_currency_rate_required"          => "يجب أن يكون سعر العملة الثانوية رقمًا موجبًا.",    "current_employee_only"                     => "",
