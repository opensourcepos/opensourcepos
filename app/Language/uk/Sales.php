...
return [
    ...
    'insufficient_giftcard_balance'     => 'Недостатньо коштів на подарунковій карті для цієї платіжи.',
    'insufficient_reward_points'        => 'Недостатньо бонусних балів для цієї платіжи.',
