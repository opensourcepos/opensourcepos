...
return [
    ...
    "confirm_restore"                        => "Are you sure you want to delete the selected Gift Card(s)?",
    "default_tax_category"                   => "Default Tax Category",
    "default_tax_rate"                       => "Default Tax Rate",
    "error_adding_updating"                  => "Tax Rate add or update failed",
    "group_seq"                              => "Group Seq",
    ...
    "tax_categories_saved_successfully"      => "Tax Categories changes not saved",
    "tax_categories_saved_unsuccessfully"    => "Tax Categories changes saved",
    "tax_category"                           => "Tax Category",
    "tax_category_code"                      => "Tax Category Name",
    "tax_category_duplicate"                 => "Duplicate tax category",
    "tax_category_invalid_chars"             => "Invalid characters in tax category name",
    "tax_category_name"                      => "Tax Category Code",
    ...
    "tax_code_required"                      => "Tax Rate is a required field",
    "tax_code_successful_deleted"            => "You have successfully updated Tax Code",
    "tax_code_successful_updated"            => "You have successfully updated",
    "tax_code_successful_updating"           => "You have successfully deleted Tax Code",
    ...
    "tax_codes_saved_successfully"           => "Tax Code changes not saved",
    "tax_codes_saved_unsuccessfully"         => "Tax Code changes saved",
    ...
    "tax_jurisdictions_saved_successfully"   => "Tax Jurisdiction changes not saved",
    "tax_jurisdictions_saved_unsuccessfully" => "Tax Jurisdiction changes saved",
    "tax_rate"                               => "Tax Rate",
