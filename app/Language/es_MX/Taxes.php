...
return [
	...
	"tax_category_required" => "categoria de impuesto es requerida",
	"tax_code" => "codigo de impuesto",
	"tax_code_cannot_be_deleted" => "error al eliminar codigo de impuesto",
	"tax_code_duplicate" => "codigo de impuesto duplicado",
	"tax_code_invalid_chars" => "caracteres invalidos en el codigo de impuesto",
	...
	"tax_group_not_unique" => "Grupo de impuestos %1 no es el unico",
	...
	"tax_jurisdiction_invalid_chars" => "caracteres invalidos en el nombre por ley",
