...
return [
    ...
    'insufficient_giftcard_balance'     => 'Ανεπαρκές υπόλοιπο δωροcard για αυτή την πληρωμή.',
    'insufficient_reward_points'        => 'Ανεπαρκή σημεία ανταμοιβής για αυτή την πληρωμή.',
    'invoice'                           => 'Τιμολόγιο',
