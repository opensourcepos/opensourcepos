...
return [
    ...
    'uninstall_warning'     => 'Η απεγκατάσταση αυτής της προσθήκης θα αφαιρέσει όλα τα δεδομένα στη βάση δεδομένων που σχετίζονται με την προσθήκη και δεν μπορεί να αναστραφεί. Είστε βέβαιοι ότι θέλετε να απεγκαταστήσετε;',
