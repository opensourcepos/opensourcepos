...
return [
	...
	"logout" => "Déconnexion",
	"manager" => "",
	"migration_needed" => "Une migration de la base de donnée vers %1 démarrera après le connexion.",
	"new" => "Nouveau",
	"no" => "",
	...
	"welcome" => "Bienvenue",
	"welcome_message" => "Bienvenue sur OSPOS, choisissez un module ci-dessous.",
	"yes" => "",
