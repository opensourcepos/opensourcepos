...
return [
	...
	"giftcards_cannot_be_deleted" => "Could not delete selected Gift Card(s), one or more of the selected Gift Card(s) has sales.",
	...
	"giftcards_change_all_to_serialized" => "Change All To Serialised",
	"giftcards_change_all_to_unserialized" => "Change All To Unserialised",
	"giftcards_confirm_bulk_edit" => "Are you sure you want to edit all the selected Gift Card(s)?",
	"giftcards_confirm_delete" => "Are you sure you want to delete the selected Gift Card(s)?",
	"giftcards_confirm_restore" => "Are you sure you want to restore the selected Gift Card(s)?",
	...
	"giftcards_must_select_giftcard_for_barcode" => "You must select at least one Gift Card to generate barcodes.",
	...
	"giftcards_serialized_giftcards" => "Serialised Gift Cards",
	"giftcards_successful_adding" => "You have successfully added Gift Card",
	"giftcards_successful_bulk_edit" => "You have successfully updated the selected Gift Cards",
	"giftcards_successful_deleted" => "You have successfully deleted Gift Card",
	...
	"giftcards_unit_price" => "Sell Price",
