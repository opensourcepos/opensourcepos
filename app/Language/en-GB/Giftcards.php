...
return [
    ...
    "bulk_edit"                          => "Bulk Edit",
    "cannot_be_deleted"                  => "Could not delete selected Gift Card(s), one or more of the selected Gift Card(s) has sales.",
    ...
    "confirm_bulk_edit"                  => "Are you sure you want to edit all the selected Gift Card(s)?",
    "confirm_delete"                     => "Are you sure you want to delete the selected Gift Card(s)?",
    "confirm_restore"                    => "Are you sure you want to restore the selected Gift Card(s)?",
    ...
    "must_select_giftcard_for_barcode"   => "You must select at least one Gift Card to generate barcodes.",
    "new"                                => "New Gift Card",
    ...
    "serialized_giftcards"               => "Serialised Gift Cards",
    "successful_adding"                  => "You have successfully added Gift Card",
    "successful_bulk_edit"               => "You have successfully updated the selected Gift Cards",
    "successful_deleted"                 => "You have successfully deleted Gift Card",
