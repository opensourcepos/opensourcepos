...
return [
    ...
    "cannot_be_deleted"     => "Could not delete the selected Supplier(s). One or more have Sales.",
    "category"              => "Category",
    ...
    "confirm_restore"       => "Are you sure you want to restore the selected Supplier(s)?",
    "cost"                  => "Cost Supplier",
    "error_adding_updating" => "Supplier update or add failed.",
    "goods"                 => "Goods Supplier",
    "new"                   => "New Supplier",
    "none_selected"         => "You have not selected any Supplier(s) to delete.",
    "one_or_multiple"       => "Supplier(s)",
    "successful_adding"     => "You have successfully added Supplier",
    "successful_deleted"    => "You have successfully deleted Supplier",
