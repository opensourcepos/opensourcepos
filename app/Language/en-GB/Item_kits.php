...
return [
	...
	"item_kits_confirm_restore" => "Are you sure you want to restore the selected Item Kit(s)?",
	"item_kits_description" => "Item Kit Description",
	"item_kits_discount" => "Discount",
	"item_kits_discount_fixed" => "Fixed Discount",
	"item_kits_discount_percent" => "Percentage Discount",
	...
	"item_kits_none_selected" => "You have not selected any Item Kit(s).",
	...
	"item_kits_successful_deleted" => "You have successfully deleted Item Kit",
