...
return [
    ...
    "detailed_rmas_report"                    => "Detailed RMA Report",
    "detailed_sales_report"                   => "Detailed Transactions Report",
    "detailed_transfers_report"               => "Detailed Transfers Report",
    "discount"                                => "Discount",
    ...
    "inventory_by_location_legend"            => "Total stock quantity per product across all locations. Cells highlighted in yellow are at or below the reorder level.",
    "inventory_by_location_report"            => "Inventory by Location Report",
