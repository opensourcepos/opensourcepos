...
return [
	...
	"config_customer_reward_duplicate" => "Please use a unique reward name.",
	"config_customer_reward_enable" => "Enable Customer Rewards",
	"config_customer_reward_invalid_chars" => "The reward name cannot contain '_'",
	...
	"config_derive_sale_quantity_tooltip" => "If checked then a new item type will be provided for items ordered by extended amount.",
	"config_dinner_table" => "Table",
	"config_dinner_table_duplicate" => "Please use an unique table name.",
	"config_dinner_table_enable" => "Enable Dinner Tables",
	"config_dinner_table_invalid_chars" => "The table name cannot contain '_'.",
	...
	"config_financial_year" => "Financial Year Start",
	...
	"config_info_configuration" => "Shop Information",
	...
	"config_mailchimp_key_successfully" => "Valid API Key.",
	"config_mailchimp_key_unsuccessfully" => "Invalid API Key.",
	...
	"config_print_bottom_margin_number" => "Bottom Margin must be a number.",
	"config_print_bottom_margin_required" => "Bottom Margin is a required field.",
	...
	"config_print_left_margin_number" => "Left Margin must be a number.",
	"config_print_left_margin_required" => "Left Margin is a required field.",
	...
	"config_print_right_margin_number" => "Default Right Margin must be a number.",
	"config_print_right_margin_required" => "Default Right Margin is a required field.",
	"config_print_silently" => "Show Print Dialog",
	"config_print_top_margin" => "Margin Top",
	"config_print_top_margin_number" => "Default Top Margin must be a number.",
	"config_print_top_margin_required" => "Default Top Margin is a required field.",
	...
	"config_receiving_calculate_average_price" => "Change Cost Price (Receiving)",
	...
	"config_stock_location_invalid_chars" => "Stock location name cannot contain '_'.",
