...
return [
	...
	"config_barcode_tooltip" => "எச்சரிக்கை: இந்த அம்சம் நகல் உருப்படிகளை இறக்குமதி செய்ய அல்லது உருவாக்க காரணமாக இருக்கலாம். நீங்கள் நகல் பட்டைக்குறியீடுகளை விரும்பவில்லை என்றால் பயன்படுத்த வேண்டாம்.",
	...
	"config_mailchimp" => "மெயில்சிம்ப்",
	"config_mailchimp_api_key" => "மெயில்சிம்ப் API விசை",
	"config_mailchimp_configuration" => "மெயில்சிம்ப் அமைப்பு",
	"config_mailchimp_key_successfully" => "API Key is valid.",
	"config_mailchimp_key_unsuccessfully" => "API Key is invalid.",
	"config_mailchimp_lists" => "மெயில்சிம்ப் பட்டியல்(கள்)",
