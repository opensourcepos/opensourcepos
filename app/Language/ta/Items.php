<?php
return [
	"items_add_minus" => "கையிருப்பு பொருட்களை கூட்டு அல்லது கழி",
	"items_allow_alt_description" => "மாற்று விளக்கத்தை அனுமதி",
	"items_amount_entry" => "தொகை உள்ளிடு",
	"items_bulk_edit" => "மொத்த திருத்தம்",
	"items_buy_price_required" => "கொள்முதல் விலை அவசியம்.",
	"items_cannot_be_deleted" => "தேர்ந்தெடுக்கப்பட்ட உருப்படி (களை) நீக்க முடியவில்லை, தேர்ந்தெடுக்கப்பட்ட ஒன்று அல்லது அதற்கு மேற்பட்ட உருப்படிகள் விற்பனையைக் கொண்டுள்ளன.",
	"items_cannot_find_item" => "பொருள் கிடைக்கவில்லை.",
	"items_categories" => "",
	"items_category" => "வகை",
	"items_category_new" => "",
	"items_category_required" => "வகை என்பது தேவையான புலம்.",
	"items_change_all_to_allow_alt_desc" => "அனைவரும் மாற்று விளக்கத்தை அனுமதிக்கவும்.",
	"items_change_all_to_not_allow_allow_desc" => "அனைவருக்கும் மாற்று விளக்கத்தை அனுமதிக்க வேண்டாம்.",
	"items_change_all_to_serialized" => "அனைத்தையும் தொடர்களாக மாற்றவும்",
	"items_change_all_to_unserialized" => "அனைத்தையும் தொடர்களாக மாற்றவும்",
	"items_change_image" => "படத்தை மாற்று",
	...
	"items_retrive_item_info" => "உருப்படி தகவலை மீட்டெடுக்கவும்",
