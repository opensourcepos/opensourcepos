<?php
return [
	'config_address' => 'Адрес на компанията',
	'config_address_required' => 'Адресът на компанията е задължително поле.',
	'config_all_set' => 'All file permissions are set correctly!',
	'config_allow_duplicate_barcodes' => 'Разрешаване на дублирани баркодове',
	'config_apostrophe' => 'апостроф',
	'config_backup_button' => 'резервно копие',
	'config_backup_database' => 'Резервно копие база данни',
	'config_barcode' => 'Баркод',
	'config_barcode_company' => 'Име на компанията',
	'config_barcode_configuration' => 'Конфигуриране на баркод',
	'config_barcode_content' => 'Съдържание на баркод',
	'config_barcode_first_row' => 'Ред 1',
	...
	'config_customer_sales_tax_support' => 'Customer Sales Tax Support',
	...
	'config_lines_per_page_number' => 'Линиите на страница трябва да са число.',
