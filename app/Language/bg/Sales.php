...
return [
    ...
    'insufficient_giftcard_balance'     => 'Недостатъчен баланс на подаръчната карта за тази плащане.',
    'insufficient_reward_points'        => 'Недостатъчно награди точки за тази плащане.',
    'invoice'                           => 'Фактура',
