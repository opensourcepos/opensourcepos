...
return [
    ...
    "cannot_be_deleted"                => "\"Невъзможно е да изтриете избрани служители",
    "change_employee"                  => "",
    ...
    "error_grant_change_disallowed"    => "Промените на правата са отключени в това демо.",
    "error_password_change_disallowed" => "Промените на пароли са отключени в това демо.",
    ...
    "manager"                          => "",
    "new"                              => "Нов служител",
    "none_selected"                    => "\"Не сте избрали служител (и)",
    ...
    "permission_desc"                  => "\"Поставете отметка в квадратчетата по-долу",
